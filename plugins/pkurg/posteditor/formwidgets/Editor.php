...
class Editor extends FormWidgetBase
{
    ...
    public function loadAssets()
    {
        ...
        $this->addJs('/plugins/pkurg/posteditor/formwidgets/editor/assets/post-editor.js?v=5');
        ...
        $this->addJs('/plugins/pkurg/posteditor/formwidgets/editor/assets/editor.js?v=1');
